    ...
    <Card className="w-full p-4 bg-white shadow-md rounded-lg">
      <CardHeader className="flex justify-between items-center mb-4">
        ...
        <div className="flex items-center">
          <span className="text-sm font-medium text-gray-500 mr-4">Production</span>
        </div>
      </CardHeader>
      <CardContent>
        {data.map((item, index) => (
      ...
      <CardFooter>
        ...
        {!hovered && (
          <CardDescription className="text-gray-800 font-medium">Total Events Triggered: 35,968</CardDescription>
        )}
      </CardFooter>
    </Card>
  );
