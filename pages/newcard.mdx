...
This component is a simple interactive card that includes a header, a content section, and a call-to-action button. It's designed for basic interaction, allowing users to trigger a modal pop-up or navigate to another page. For instance, it could be used as an invitation to get in touch, with a "Contact Us" prompt.
...
| ------- | ----------- | ----------- | ---------- | --------------- |
| v2.0    | Nuojin Zhang | Nuojin Zhang | 20/03/2024 | modified version |
