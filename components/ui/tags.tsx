...
export function InnovativeTags() {
  return <Theme componentName="tags" componentStyle="innovative" componentDesktopView="InnovativeTagComponent" componentMobileView="InnovativeTagComponentMobile"/>;
}
